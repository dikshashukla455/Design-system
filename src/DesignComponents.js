...
function DesignComponents() {
  return (
    ...
    {/* Confirm dialog box */}
    <ConfirmBox type="confirm" label="Do the thing?" message="Doing the thing means that you’ll need to reset the system."/>
    {/* Confirm dialog box */}
    <ConfirmBox type="delete" label="Do you want to delete?" message="Once you delete this, it will be gone forever. Make sure you give thanks to it first."/>
    </div>
    </>
  )
}
